...
lines <- system("wc -l C:\\Users\\nivibalu\\Documents\\capstone\\project\\*.txt", intern=TRUE)
words <- system("wc -w C:\\Users\\nivibalu\\Documents\\capstone\\project\\*.txt", intern=TRUE)
longest <- system("wc -L C:\\Users\\nivibalu\\Documents\\capstone\\project\\*.txt", intern=TRUE)
...
lines <- system("wc -l C:\\Users\\nivibalu\\Documents\\capstone\\project\\sample\\*.txt", intern=TRUE)
words <- system("wc -w C:\\Users\\nivibalu\\Documents\\capstone\\project\\sample\\*.txt", intern=TRUE)
longest <- system("wc -L C:\\Users\\nivibalu\\Documents\\capstone\\project\\sample\\*.txt", intern=TRUE)
...
```{r, cache=TRUE}
setwd("C:/Users/nivibalu/Documents/capstone/project//output")
